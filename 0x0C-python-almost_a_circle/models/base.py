#!/usr/bin/python3
"""
This class will be the “base” of all the other classes in this project.
The goal of this, is to manage id attribute in all your future classes
...
class Base:
    ...
    def from_json_string(json_string):
        """transform a JSON string representation
